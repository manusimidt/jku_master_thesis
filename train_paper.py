...
def train(Mx: VanillaEnv, My: VanillaEnv, net, optim) -> float:
    ...
    metric_values = torch.tensor(psm.psm_fb(actionsY, actionsX)).to(device)  # TODO maybe these two must be switched!
...
if __name__ == '__main__':
    ...
    torch.save(state, 'ckpts/loss_wide_paper_psm_fb_yx.pth')
